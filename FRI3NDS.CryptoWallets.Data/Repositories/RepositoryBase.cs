...
namespace FRI3NDS.CryptoWallets.Data.Repositories
{
    ...
    public class UnsafeRepositoryBase
    {
        ...
        protected List<T> CallProcedure<T>(string name, object parameters)
        {
            return _dataContext.Connection.Query<T>(name, parameters, this._dataContext.Transaction, commandType: CommandType.StoredProcedure)
                .ToList();
        }
